...
The readiness report now lists repository-local evidence separately from the missing terminal paths: directly reusable truth frames, sources requiring placement or zone composition, and provisional visual studies. It does not mark those references as completed terminal art. Tier 1 currently maps 9 direct, 13 composed and 1 study reference, with 5 unmapped; Tier 2 maps 4 composed and 3 studies, with 24 unmapped. All 111 unique proposed terminal paths remain missing, so `--strict` still fails. The separate upper-cabinet soot-edge trial is a study pending live visual review.
