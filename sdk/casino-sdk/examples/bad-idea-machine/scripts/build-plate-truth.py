...
def build():
    ...
    parts = {
        ...
        'heroBody': photographic_body(reference, [
            (577,92),(580,90),(588,89),(606,88),(626,89),(637,91),
            (640,92),(636,93),(583,93),
        ], .7),
        'stackBody': photographic_body(reference, [
            (579,96),(583,93),(595,92),(625,92),(635,93),(641,96),(641,111),
            (639,117),(633,120),(583,120),(580,117),(581,108),
        ], .8),
        'heroShadow': contact_shadow([
            (580,92),(588,92),(634,92),(640,93),(636,96),(582,96),
        ], 43),
