...
## Floor shard study pending review

A separate transparent ceramic cutout is proposed on the photographed rug/floor in front of the stove at (456, 535), 112×63 display pixels. Its blurred contact uses the same alpha at a two-pixel drop and can be toggled separately from both floor ceramic and stove ceramic. This built-in image generation is supplemental damage art, not a replacement room image or an accepted plate fragment. Its material, size, floor support and edge quality require visual review. The Kitchen rebuild asset budget becomes 17 files / 460,000 bytes; the authored-room and full-bundle ceilings do not change.
