...
const props: readonly KitchenProp[] = [
  ...
  {
    id: 'toast',
    label: 'Hero toast slice',
    material: 'food',
    support: { zoneId: 'right-counter', surface: 'top/front of toaster stack' },
    rest: { x: 651, y: 244, rotation: 0 },
    states: ['resting', 'airborne', 'landed', 'charred'],
    defaultState: 'resting',
  },
  {
    id: 'toast-stack',
    label: 'Remaining toast stack',
    material: 'food',
    support: { zoneId: 'right-counter', surface: 'toaster top / slots' },
    rest: { x: 664, y: 243, rotation: 0 },
    states: ['stacked', 'missing-one', 'disturbed', 'charred'],
  ...
  {
    id: 'hero-plate',
    label: 'Hero ceramic plate',
    material: 'ceramic',
    support: { zoneId: 'plate-cabinet', surface: 'front/top of lower plate stack' },
    rest: { x: 623, y: 118, rotation: 0 },
    states: ['resting', 'tipping', 'airborne', 'fracturing', 'shattered'],
    defaultState: 'resting',
  },
  {
    id: 'plate-stack',
    label: 'Remaining ceramic plate stack',
    material: 'ceramic',
    support: { zoneId: 'plate-cabinet', surface: 'lower cabinet shelf' },
    rest: { x: 623, y: 121, rotation: 0 },
    ...
    beats: [
      {
        ...
        actor: 'plate-cabinet',
        target: 'plate-stack',
        action: 'lower shelf shifts the stack and frees the hero plate',
        contact: { x: 623, y: 132 },
    ...
    beats: [
      {
        ...
        actor: 'plate-cabinet',
        target: 'plate-stack',
        action: 'plate stack shifts and frees the hero plate at the shelf edge',
        contact: { x: 625, y: 130 },
        damage: [{ zoneId: 'plate-cabinet', state: 'hinge-stressed' }],
      },
      {
