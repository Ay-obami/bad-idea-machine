...
After the subsequent redeploy, the production page was refreshed and the reflection-only state displayed **Current: kettle · counter reflection** and **Reconstruction · counter reflection**. This confirms the label fix is live.
